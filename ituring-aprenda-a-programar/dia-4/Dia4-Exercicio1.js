let totalvalsemgorjeta = 0
let totalcomgorjeta = 0
let qtdvendamenor50 = 0
let somacomgorjeta = 0
let somasemgorjeta = 0
let resposta = 0
let receita = 
[
...
for(let totalvalsemgorjeta of receita)
{
    somasemgorjeta += totalvalsemgorjeta.valor
}
console.log("Total Vendas Sem Gorjeta: " ,somasemgorjeta)

for(let totalcomgorjeta of receita)
{
    somacomgorjeta += totalcomgorjeta.gorjeta
}
console.log("Total Vendas Com Gorjeta: " ,somacomgorjeta + somasemgorjeta)


for (let qtde of receita) {
    if (qtde.valor <= 50) {
        qtdvendamenor50 = qtdvendamenor50 + 1
    }
}
    console.log("Quantidade de Vendas Menor que R$ 50,00 Reais é: " , qtdvendamenor50)
